...
//        players.map(player=><div key={player.id} className="card bg-base-100 w-96 shadow-xl">
//            <figure>
//              <img className="w-full h-[250px]"
//                src={player.batsman_img}
//                alt="playerbabajira" />
//            </figure>
...
//              <button className="border  p-1 rounded-md"><small>All Rounder</small></button>
//              </div>
//              <hr />
//              <h1 className="font-bold">Ratting</h1>
...
//                 <button className="border p-1">Choose player</button>
//              </div>
